...
int main() {
 ...
 createVect(pA, n); 
 view(pA, n); 
 cout<<"Індекс максимального елемента: " << maxElem(pA, n) << endl;
 cout << "Задайте кiлькiсть елементiв ->";
 cin >> n;
 pB = new int[n];
 createVect(pB, n);
 view(pB, n);
 cout<<"Індекс максимального елемента: " << maxElem(pB, n)<< endl;
 cout << "Задайте кiлькiсть елементiв ->";
 cin >> n;
 pC = new int[n];
 createVect(pC, n);
 view(pC, n);
 cout<<"Індекс максимального елемента: " << maxElem(pC, n)<< endl;
 delete []pA; 
 delete []pB;
 delete []pC;
 return 0;
